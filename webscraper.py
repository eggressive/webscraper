...
async def webscraper(target_url, instructions):
    ...
    try:
        ...
        await scraper.take_screenshot(path="screenshots/screenshot.png")  # Save screenshot to file
...
async def main():
    ...
    html_content = await visualizeCourses(
        result=result,
    ...
    if html_content:  # Ensure html_content is not None
        ...
        print("❌ Error: visualizeCourses did not return any HTML content.")
